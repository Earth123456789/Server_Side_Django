...
class BlogListView(LoginRequiredMixin, PermissionRequiredMixin, View):
    login_url = '/authen/'
...
class BlogDetailView(LoginRequiredMixin, PermissionRequiredMixin, View):
    login_url = '/authen/'
    permission_required = ["blogs.view_blog"]
...
class BlogEditView(LoginRequiredMixin, PermissionRequiredMixin, View):
    login_url = '/authen/'
...
class BlogDeleteView(LoginRequiredMixin, PermissionRequiredMixin, View):
    login_url = '/authen/'
